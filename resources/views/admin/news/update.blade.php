...
<div class="form-floating mb-3">
  <input type="text" class="form-control" id="floatingInput" value="{{ $news->title}}" name="caption" placeholder="name@example.com" required>
  <label for="floatingInput">News Caption</label>
</div>

<div class="mb-3">
<label for="floatingTextarea2">Details</label>  
  <textarea class="form-control"  id="newsnote" name="news" required>{{ $news->annoucement}}</textarea>
...
<div class="form-floating mb-3">
  <select class="form-select" id="floatingSelect" required name="status" aria-label="Floating label select example">
    ...
    <option {{ ($news->status = 2) ? ' selected ' : '' }} value="2">Inactive</option> 
  </select>
