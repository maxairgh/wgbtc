<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">WORD OF GRACE LEMAS</span>
            ...
            <i class="align-middle" data-feather="user"></i> <span class="align-middle">view</span>
            </a>
			</li>
			<li class="sidebar-item">
			...
			<li class="sidebar-item">
				<a class="sidebar-link" href="{{ route('learner.index') }}">
              ...
              <i class="align-middle" data-feather="users"></i> <span class="align-middle">User Management</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{ route('session.index') }}">
