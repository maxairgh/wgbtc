...
{{ $courses->links() }}   
    ...
    <div class="col-md-4">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" id="floatingInput" wire:model="courseid" placeholder="name@example.com" readonly required>
          ...
          <div class="form-floating mb-3">
            <input type="number" class="form-control" id="floatingInput" wire:model="creditValue" placeholder="name@example.com" required>
            <label for="floatingInput">Credit Value</label>
            @error('creditValue') <span class="text-danger">{{ $message }}</span> @enderror
          </div>
        ...
        <div class="col-md-12 text-center">
            <button type="submit" wire:click="SaveCourse" class="btn btn-primary btn-sm">{{ $label }}</button>
        </div>
